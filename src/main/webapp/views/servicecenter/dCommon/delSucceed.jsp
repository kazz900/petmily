...
<h3 style="margin-top:5px; font-size:28px;">삭제 요청이 전송되었습니다!</h3>
<a href="/petmily/suggest?mseq=<%=member.getMemberSeq()%>">
	<button style="margin-bottom:15px; width:200px; height:40px; 
	border-radius:5px; border:1px solid black;
	box-shadow:1px 1px 0px 1px #cfcfcf;">확인</button>
</a>
</body>
</html>
...
<body>
<img src="/petmily/resources/images/servicecenter/x_mark.png" style="width:150px; height:auto;">
<h1 style="margin-bottom:5px; font-size:36px;">이런!</h1>
<h3 style="margin-top:5px; font-size:28px;">건의사항을 읽어오던 중 문제가 발생하였습니다!</h3>

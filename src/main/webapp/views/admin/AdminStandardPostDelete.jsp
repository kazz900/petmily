...
<body>
	...
	<div class="block" align="center" style="text-align: center;">
		...
		<br>
		<form id="idform" class="sform" action="/petmily/asps" method="post">
		...
		<form id="contentform" class="sform" action="/petmily/asps" method="post">
		...
		<form id="gradeform" class="sform" action="/petmily/asps" method="post">
	...
	<h1 align="center" style="text-align: center; margin-top: 0;">일반 게시글 관리</h1>
		...
		<table id="outer" align="center" border="1" cellspacing="0"
			...
			<tr>
				...
				<td><input type="button" value="삭제" id="chggrade" 
					onclick="location.href='/petmily/atss?postSeq=<%= adm.getPostSeq()%>&keyword=<%=keyword %>&action=<%= action%>';"></td>
			</tr>

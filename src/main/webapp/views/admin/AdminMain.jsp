...
<script type="text/javascript">
	function liclick(num) {
		if (num == '1') {
			location.href = "/petmily/adminmain?num=1";
		} else if (num == '2') {
			location.href = "/petmily/srtd?num=2";
		} else if (num == '3') {
			alert("3번");
		} else if (num == '4') {
			alert("4번");
...
<body>
	<div class="info-content">
		<div class="info-detail02">
			...
			<ul class="tabs">
				<li id="1" class="tab-link" data-tab="tab-1"><a href="#"
					onclick="liclick('1')">업체등록</a></li>
				<li id="2" class="tab-link" data-tab="tab-2"><a href="#"
					onclick="liclick('2')">업체삭제</a></li>
				<li id="3" class="tab-link" data-tab="tab-3"><a href="#"
					onclick="liclick('3')">회원 등급 변경</a></li>
				<li id="4" class="tab-link" data-tab="tab-4"><a href="#"
					onclick="liclick('4')">일반게시판 관리</a></li>
				<li id="5" class="tab-link" data-tab="tab-5"><a href="#"
					onclick="liclick('5')">거래게시판 관리</a></li>
			</ul>

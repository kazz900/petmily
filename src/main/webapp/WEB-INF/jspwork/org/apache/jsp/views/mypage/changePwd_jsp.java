 ...
 * Generated at: 2023-09-05 07:53:48 UTC
...
public final class changePwd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("$(function(){\r\n");
      out.write("	var pwdValue1 = document.getElementById(\"userpwd1\");\r\n");
      out.write("	var pwdValue2 = document.getElementById(\"userpwd2\");\r\n");
      out.write("	\r\n");
      out.write("	var reg = /^(?=.*[a-zA-Z])(?=.*\\d)(?=.*[!@#$])[a-zA-Z\\d@!#$]{6,15}[a-zA-Z\\d@!#$]$/;\r\n");
      out.write("	\r\n");
      out.write("	var notice = document.getElementById(\"notice\");\r\n");
      out.write("	var notice2 = document.getElementById(\"notice2\");\r\n");
      out.write("	var submitBtn = document.getElementById(\"submit\");\r\n");
      out.write("\r\n");
      out.write("	notice.hidden = true;\r\n");
      out.write("	notice2.hidden = true;\r\n");
      out.write("	submitBtn.disabled = true;\r\n");
      out.write("	\r\n");
      out.write("\r\n");
      out.write("	\r\n");
      out.write("	pwdValue1.addEventListener(\"keyup\", function(){\r\n");
      out.write("		if (!reg.test(pwdValue1.value)) {\r\n");
      out.write("			notice.hidden = false;\r\n");
      out.write("			submitBtn.disabled = true;\r\n");
      out.write("		} else {\r\n");
      out.write("			notice.hidden = true;\r\n");
      out.write("			submitBtn.disabled = true;\r\n");
      out.write("			if(pwdValue1.value == pwdValue2.value){\r\n");
      out.write("				submitBtn.disabled = false;\r\n");
      out.write("			}\r\n");
      out.write("		}\r\n");
      out.write("	});\r\n");
      out.write("	\r\n");
      out.write("	pwdValue2.addEventListener(\"keyup\", function(){\r\n");
      out.write("		if (!reg.test(pwdValue2.value)) {\r\n");
      out.write("			notice.hidden = false;\r\n");
      out.write("			submitBtn.disabled = true;\r\n");
      out.write("		} else {\r\n");
      out.write("			notice.hidden = true;\r\n");
      ...
      out.write("	location.href=\"/petmily/views/myPage/changeMyinfo.jsp\";\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("</script>\r\n");
      out.write("</head>\r\n");
...
if(member == null){ 
 ...
 if(member == null) { 
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("<div class=\"block\" style=\"display:flex; justify-content:center;\">\r\n");
      out.write("	<div class=\"wrapper\" style=\"margin-top:100px;\">\r\n");
      out.write("	<div style=\"text-align:center;\">\r\n");
      out.write("		<p style=\"margin-bottom:10px; font-size:24px; font-weight:bold;\">비밀번호 변경 페이지</p>\r\n");
      out.write("		<!-- <p style=\"margin-bottom:10px; font-size:16px;\">비밀번호를 정확히 입력하면 변경하기 버튼이 생깁니다.</p> -->\r\n");
      out.write("	</div>\r\n");
      out.write("		<form action=\"/petmily/pwdupdate\" method=\"post\" onsubmit=\"return validate();\">\r\n");
      out.write("		<p style=\"font-size:14px;\" id=\"notice\">비밀번호는 영어 대/소문자, 특수문자, 숫자를 포함하여 최소 6자리 이상으로 설정해주세요.</p>\r\n");
      out.write("		<p style=\"font-size:14px;\" id=\"notice2\">비밀번호가 일치하지 않습니다.<br>확인 후 다시 입력해주세요.</p>\r\n");
      out.write("		\r\n");
      ...
      out.write("						readonly>\r\n");
      out.write("				<tr>\r\n");
      out.write("					<th width=\"140\">비밀번호</th>\r\n");
      out.write("					<td><input type=\"password\" name=\"mpwd\" id=\"userpwd1\" required>\r\n");
      out.write("					</td>\r\n");
      out.write("				</tr>\r\n");
      out.write("				\r\n");
      out.write("				<tr>\r\n");
      out.write("					<th width=\"140\">비밀번호 확인</th>\r\n");
      out.write("					<td><input type=\"password\" id=\"userpwd2\" required>\r\n");
      out.write("					</td>\r\n");
      out.write("				</tr>\r\n");
      out.write("			</table>\r\n");
      out.write("			<div style=\"text-align:center; margin-top:10px;\">\r\n");
      out.write("			\r\n");
      out.write("				<input type=\"button\" value=\"이전으로\" id=\"prev\"\r\n");
      out.write("				style=\"margin-bottom:15px; width:150px; height:30px; \r\n");
      out.write("				border-radius:5px; border:1px solid black;\r\n");
      out.write("				box-shadow:1px 1px 0px 1px #cfcfcf;\" onclick=\"history.go(-1)\">\r\n");
      out.write("				&nbsp; \r\n");
      out.write("				<input type=\"submit\" value=\"변경하기\" id=\"submit\"\r\n");
      out.write("				style=\"margin-bottom:15px; width:150px; height:30px; \r\n");
      out.write("				border-radius:5px; border:1px solid black;\r\n");

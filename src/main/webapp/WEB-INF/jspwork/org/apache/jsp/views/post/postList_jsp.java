 ...
 * Generated at: 2023-09-01 07:37:31 UTC
...
public final class postList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/post/../common/main.jsp", Long.valueOf(1693553799811L));
  }
...
if(member == null){ 
 ...
 if(member == null) { 
      ...
      out.write("								<input id=\"newpost\" type=\"text\" placeholder=\"오늘 무슨 일이 있었나요?\"\n");
      out.write("									onclick=\"openNewPostForm();\">\n");
      out.write("								<div class=\"new-post-form-popup\" id=\"newPostForm\">\n");
      out.write("									<!-- TEST CREATE NEW POST : NEED TO CHANGE LATER -->\n");
      out.write("									<form action=\"/petmily/spnewpost?memberseq=16\" class=\"form-container\" method=\"post\">\n");
      out.write("										<textarea name=\"post-content\" id=\"post-content-textarea\" cols=\"30\" rows=\"10\" autofocus required></textarea>\n");
 ...
 for(StandardPost sp : list) { 
      ...
      out.print( sp.getLastModifieddate() );
      out.write("\n");
      out.write("										</td>\n");
      out.write("										");

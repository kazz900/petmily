...
public class PetDao {
	...
	public int updatePet(Connection conn, Pet pet, int memberSeq) {
		
		int result = 0;
		PreparedStatement pstmt = null;
		
		String query = "update pet set pet_name = ?, pet_type =? pet_size = ?"
				+ " where member_seq = ? and pet_seq ";
